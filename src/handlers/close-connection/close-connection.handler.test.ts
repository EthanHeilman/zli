...
import { mockConnectionSummary, mockDbConnectionSummary, mockKubeConnectionSummary, mockRDPConnectionSummary, mockSQLServerConnectionSummary, mockSpaceSummary, unitTestMockSetup } from 'utils/unit-test-utils';
...
describe('Close Connection suite', () => {
    ...
    test('2982: Close all connections', async () => {
        ...
        jest.spyOn(ConnectionHttpService.prototype, 'ListSQLServerConnections').mockImplementation(async () => Promise.resolve([mockSQLServerConnectionSummary]));
