import { DigitalOceanDropletSize } from 'system-tests/digital-ocean/digital-ocean.types';
import { allTargets, chartsBranch, bzeroAgentBranch, bzeroAgentVersion, bzeroKubeAgentImageName, configService, digitalOceanRegistry, doApiKey, logger, resourceNamePrefix, systemTestEnvId, systemTestEnvName, systemTestRegistrationApiKey, systemTestTags, systemTestUniqueId, testTargets, providerCredsPath, bzeroCredsPath, RUN_AS_SERVICE_ACCOUNT } from 'system-tests/tests/system-test';
import { checkAllSettledPromise, stripTrailingSlash } from 'system-tests/tests/utils/utils';
import * as k8s from '@kubernetes/client-node';
import { ClusterTargetStatusPollError, RegisteredDigitalOceanKubernetesCluster } from 'system-tests/digital-ocean/digital-ocean-kube.service.types';
...
import { cleanupHelmAgentInstallation } from 'system-tests/tests/system-test-cleanup';
